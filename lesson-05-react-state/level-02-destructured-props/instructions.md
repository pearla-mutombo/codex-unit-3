...
17. Add a red dot breakpoint in the `Main` function of `Main.jsx`.
...
- To do structure the `props` parameter, replace it with curly braces and a list of properties to destructure.
